        ...
        <div className="list_main">
          <div className="circlepart">
            <div className="thislesson">
              {t("Listlesson.2")}{" "}
              <span className="abouthtml">{t("Listlesson.3")}</span>
            </div>
                ...
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 1 ? "dp" : 1 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(1)}
                    id="c_1"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 1 ? "1" : 1 < numberS ? "1" : null}
                  </h5>
                </li>
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 2 ? "dp" : 2 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(2)}
                    id="c_2"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 2 ? "2" : 2 < numberS ? "2" : null}
                  </h5>
                </li>
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 3 ? "dp" : 3 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(3)}
                    id="c_3"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 3 ? "3" : 3 < numberS ? "3" : null}
                  </h5>
                </li>
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 4 ? "dp" : 4 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(4)}
                    id="c_4"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 4 ? "4" : 4 < numberS ? "4" : null}
                  </h5>
                </li>
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 5 ? "dp" : 5 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(5)}
                    id="c_5"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 5 ? "5" : 5 < numberS ? "5" : null}
                  </h5>
                </li>
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 6 ? "dp" : 6 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(6)}
                    id="c_6"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 6 ? "6" : 6 < numberS ? "6" : null}
                  </h5>
                </li>
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 7 ? "dp" : 7 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(7)}
                    id="c_7"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 7 ? "7" : 7 < numberS ? "7" : null}
                  </h5>
                </li>
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 8 ? "dp" : 8 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(8)}
                    id="c_8"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 8 ? "8" : 8 < numberS ? "8" : null}
                  </h5>
                </li>
                <li className="listpage_list_item">
                  ...
                  <span
                    className={`listpage_list_item_circle ${
                      numberS === 9 ? "dp" : 9 < numberS ? "dp" : null
                    }  `}
                    onClick={() => ClickedFunction(9)}
                    id="c_9"></span>{" "}
                  <h5 className="listpage_list_item_text">
                    {numberS === 9 ? "9" : 9 < numberS ? "9" : null}
                  </h5>
                </li>
              </ul>
            </div>
          ...
          <div className="training">
            <div>
              ...
              <div className="description">{t("Listlesson.5")}</div>
          ...
          <div className="yourcourses">
            ...
            <div className="courscard">
              ...
              <div
                ...
                <p className="itemtitle">
                  {t("Listlesson.14")} <br /> {t("Listlesson.17")}
                </p>
              </div>
              <div
                className={`yourcoursescard ${
                ...
                <p className="itemtitle">
                  {t("Listlesson.18")} <br /> {t("Listlesson.19")}
                </p>
              </div>
              <div
                className={`yourcoursescard ${
              ...
              <div
                ...
                <p className="itemtitle">
                  {t("Listlesson.22")} <br /> {t("Listlesson.19")}
                </p>
              </div>
              <div
                className={`yourcoursescard ${
                ...
                <p className="itemtitle">
                  {t("Listlesson.24")} <br /> {t("Listlesson.25")}?
                </p>
              </div>
              <div
                className={`yourcoursescard ${
                ...
                <p className="itemtitle">
                  {t("Listlesson.26")} <br /> {t("Listlesson.27")}
                </p>
              </div>
              <div
                className={`yourcoursescard ${
